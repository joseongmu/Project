<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <% 
try{
	String query = "SELECT C.profile_img,C.Id,C.nickname,A.title,substr(A.cratedat,6,6) as cratedat FROM content as A, reserve as B, user as C where A.Id=B.content_id and C.Id=B.user_id and B.inbox_check='1' ORDER BY A.cratedat;";
...
%>	
        ...
        <a href="#">
            <img src="Profile_img/<%out.println(profile_img); %>" id="profile_img_inbox"/>
        </a>
        <span class="meta">
          <a href="/exhalerelax/"><%out.println(nickname);%>.</a>
          <br/>
