...
<%@include file="../../CommonT.jsp" %>
 ...
 <% 
try{
	String query = "SELECT C.profile_img,C.Id,C.nickname,A.title,B.cratedat FROM content as A, reserve as B, user as C where A.Id=B.content_id and C.Id=B.user_id and B.inbox_check='1' and B.sign='1' ORDER BY A.cratedat;";
